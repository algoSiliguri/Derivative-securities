...
class BSM:
    ...
    ## A function to plot the charts based on q2i
    def plot_q2i(self):
    ...
    #     sigma_list = np.arange(0.05, 0.8, 0.05)
    #     sigma_op_list = []
    ...
    #     for i in dte_dic.values():
    #         self.days_to_expiry = i
    #         dte_op_list.append(self.calc_option_value())

    #     pd_sigma = pd.DataFrame(
    #         {"Time to maturity": list(dte_dic.values()),
    #          "Labels": list(dte_dic.keys()),
    #          "Black Scholes Option Price": dte_op_list}
    #     )
    #     ut.Utilities.plot_chart(pd_sigma)
    ...
    #     r_list = np.arange(0.0, 0.1425, 0.0025)
    #     r_op_list = []
